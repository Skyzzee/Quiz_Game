 ...
 */
class getDifficultyRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DifficultyRepository.php';

        return $container->privates['App\\Repository\\DifficultyRepository'] = new \App\Repository\DifficultyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
