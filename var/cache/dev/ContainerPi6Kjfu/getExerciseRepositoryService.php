 ...
 */
class getExerciseRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExerciseRepository.php';

        return $container->privates['App\\Repository\\ExerciseRepository'] = new \App\Repository\ExerciseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
