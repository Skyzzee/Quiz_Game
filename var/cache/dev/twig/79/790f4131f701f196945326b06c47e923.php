...
class __TwigTemplate_f27cf770ef8fcd7be71fac9786f99545 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Modifier le thème</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "category/_form.html.twig", ["button_label" => "Modifier le thème"]);
        echo "

    <a href=\"";
        // line 10
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_category_index");
        echo "\" class=\"btn btn-primary\">Retour à la liste de thème</a>
    <a href=\"";
        // line 11
...
{% block title %}Modifier le thème{% endblock %}

{% block body %}
    <h1>Modifier le thème</h1>

    {{ include('category/_form.html.twig', {'button_label': 'Modifier le thème'}) }}

    <a href=\"{{ path('app_category_index') }}\" class=\"btn btn-primary\">Retour à la liste de thème</a>
    <a href=\"{{ path('app_exercise_index') }}\" class=\"btn btn-primary\">Retour à la création de quiz</a>

    {{ include('category/_delete_form.html.twig') }}
{% endblock %}
", "category/edit.html.twig", "C:\\Users\\bchap\\Desktop\\Quiz_Game\\templates\\category\\edit.html.twig");
    }
}
