...
class __TwigTemplate_91bac65cd57e5eb644bf5fb71acc1824 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Menu Administrateur</h1>
    <h2>Information utilisateur n°";
        // line 7
    ...
    <a href=\"";
        ...
        echo "\" class=\"btn btn-primary\">Retour sur la page d'accueil Admin</a>

    ";
        // line 32
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 32, $this->source); })()), "roles", [], "any", false, false, false, 32), 0, [], "array", false, false, false, 32) != "ROLE_ADMIN")) {
            echo " ";
            // line 33
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 33, $this->source); })()), "id", [], "any", false, false, false, 33)]), "html", null, true);
            echo "\" class=\"btn btn-primary\">Modifier l'utilisateur</a>
    ";
        }
        // line 35
        echo "
";
    ...
    {
        return array (  143 => 35,  137 => 33,  134 => 32,  129 => 30,  121 => 25,  114 => 21,  107 => 17,  100 => 13,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <h2>Information utilisateur n°{{ user.id }}</h2>
    ...
    <a href=\"{{ path('app_admin_index') }}\" class=\"btn btn-primary\">Retour sur la page d'accueil Admin</a>

    {% if  user.roles[0] != 'ROLE_ADMIN'  %} {# Possibilité de Modifier tous les utilisateurs SAUF l' Admin #}
        <a href=\"{{ path('app_admin_edit', {'id': user.id}) }}\" class=\"btn btn-primary\">Modifier l'utilisateur</a>
    {% endif %}

{% endblock %}
", "admin/show.html.twig", "C:\\Users\\bchap\\Desktop\\Quiz_Game\\templates\\admin\\show.html.twig");
    }
}
