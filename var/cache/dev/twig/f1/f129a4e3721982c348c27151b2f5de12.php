...
class __TwigTemplate_39fd2c3344a65bc7c230423d39a33fe7 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 9
        echo twig_include($this->env, $context, "admin/_form.html.twig", ["button_label" => "Valider la modification"]);
        echo "
...
{% block body %}
    ...
    <h2>Modifier l'utilisateur n°{{ user.id }}</h2>

    {{ include('admin/_form.html.twig', {'button_label': 'Valider la modification'}) }}
...
{% endblock %}
", "admin/edit.html.twig", "C:\\Users\\bchap\\Desktop\\Quiz_Game\\templates\\admin\\edit.html.twig");
    }
}
